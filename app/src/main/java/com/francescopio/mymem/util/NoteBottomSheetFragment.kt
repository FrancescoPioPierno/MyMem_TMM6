package com.francescopio.mymem.util
...
class NoteBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun setListener(){
      /*
      Creazione di una Listener function che manda "informazioni" dal bottom sheet
      al fragment
       */
        ...
        layoutImage1.setOnClickListener{
        ...
        layoutWebUrl1.setOnClickListener{
